...
What is important for you to understand is that only resources allowing for adaptation are actual OER; if you can't adapt it, then it's not open. See the slide below: a resource with a Non-Derivatives license stops you from making any changes to it, therefore it is not open!
